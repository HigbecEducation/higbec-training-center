...
console.log("Vercel DB Host:", process.env.DB_HOST);
import dns from "dns";
  ...
  static async create(data) {
    ...
    try {
      const result = await client.query(
       ...
       (full_name, phone_number, email, college_name, branch, semester, batch_type, registration_type, project_title, group_members, payment_screenshot_path)
