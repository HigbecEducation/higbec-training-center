...
// Use individual connection parameters with environment variables
// Fallback to known working values for development
const SUPABASE_CONFIG = {
  host: process.env.DB_HOST || "db.eleqldrququulsotmeaz.supabase.co",
  port: parseInt(process.env.DB_PORT) || 5432,
  database: process.env.DB_NAME || "postgres",
  user: process.env.DB_USER || "postgres",
  password: process.env.DB_PASSWORD || "HigbecSupabase2024!@#",
  ssl: {
...
if (!SUPABASE_CONFIG.host || !SUPABASE_CONFIG.password) {
  throw new Error(
    "Missing required database configuration. Please check your environment variables."
  );
}
